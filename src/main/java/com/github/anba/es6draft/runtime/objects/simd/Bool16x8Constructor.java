 ...
 * <h2>SIMD objects</h2>
 * <ul>
 * <li>The SIMD.Bool16x8 Constructor
 * <li>Properties of the SIMD.Bool16x8 Constructor
 * </ul>
 */
public final class Bool16x8Constructor extends BuiltinConstructor implements Initializable {
    private static final SIMDType SIMD_TYPE = SIMDType.Bool16x8;
    @SuppressWarnings("unused")
    private static final int ELEMENT_SIZE = SIMDType.Bool16x8.getElementSize();
    private static final int VECTOR_LENGTH = SIMDType.Bool16x8.getVectorLength();

    public Bool16x8Constructor(Realm realm) {
    ...
    protected BuiltinFunction clone() {
        return new Bool16x8Constructor(getRealm());
    }

    /**
     * Properties of the SIMD.Bool16x8 Constructor
     */
    public enum Properties {
        ...
        public static final Intrinsics prototype = Intrinsics.SIMD_Bool16x8Prototype;
