 ...
 * <h2>SIMD objects</h2>
 * <ul>
 * <li>Properties of the SIMD.Float32x4 Prototype Object
 * </ul>
 */
public final class Float32x4Prototype extends OrdinaryObject implements Initializable {
    ...
    public Float32x4Prototype(Realm realm) {
        super(realm);
    }
    ...
    /**
     * Properties of the SIMD.Float32x4 Prototype Object
     */
    public enum Properties {
        ...
        public static final Intrinsics constructor = Intrinsics.SIMD_Float32x4;
        ...
        public static Object toLocaleString(ExecutionContext cx, Object thisValue, Object locales, Object options) {
            ...
            for (int i = 0; i < VECTOR_LENGTH; ++i) {
                double element = (float) value.asDouble()[i];
                /* steps 5.a-c */
