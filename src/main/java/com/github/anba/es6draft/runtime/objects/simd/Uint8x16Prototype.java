 ...
 * <h2>SIMD objects</h2>
 * <ul>
 * <li>Properties of the SIMD.Uint8x16 Prototype Object
 * </ul>
 */
public final class Uint8x16Prototype extends OrdinaryObject implements Initializable {
    ...
    public Uint8x16Prototype(Realm realm) {
        super(realm);
    }
    ...
    /**
     * Properties of the SIMD.Uint8x16 Prototype Object
     */
    public enum Properties {
        ...
        public static final Intrinsics constructor = Intrinsics.SIMD_Uint8x16;
        ...
        public static Object toLocaleString(ExecutionContext cx, Object thisValue, Object locales, Object options) {
            ...
            for (int i = 0; i < VECTOR_LENGTH; ++i) {
                double element = value.asInt()[i] & 0xff;
                /* steps 5.a-c */
