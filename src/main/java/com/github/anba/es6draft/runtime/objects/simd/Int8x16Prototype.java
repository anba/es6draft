 ...
 * <h2>SIMD objects</h2>
 * <ul>
 * <li>Properties of the SIMD.Int8x16 Prototype Object
 * </ul>
 */
public final class Int8x16Prototype extends OrdinaryObject implements Initializable {
    ...
    public Int8x16Prototype(Realm realm) {
        super(realm);
    }
    ...
    /**
     * Properties of the SIMD.Int8x16 Prototype Object
     */
    public enum Properties {
        ...
        public static final Intrinsics constructor = Intrinsics.SIMD_Int8x16;
        ...
        public static Object toLocaleString(ExecutionContext cx, Object thisValue, Object locales, Object options) {
            ...
            for (int i = 0; i < VECTOR_LENGTH; ++i) {
                double element = (byte) value.asInt()[i];
                /* steps 5.a-c */
