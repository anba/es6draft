 ...
 * <h2>SIMD objects</h2>
 * <ul>
 * <li>The SIMD.Bool32x4 Constructor
 * <li>Properties of the SIMD.Bool32x4 Constructor
 * </ul>
 */
public final class Bool32x4Constructor extends BuiltinConstructor implements Initializable {
    private static final SIMDType SIMD_TYPE = SIMDType.Bool32x4;
    @SuppressWarnings("unused")
    private static final int ELEMENT_SIZE = SIMDType.Bool32x4.getElementSize();
    private static final int VECTOR_LENGTH = SIMDType.Bool32x4.getVectorLength();

    public Bool32x4Constructor(Realm realm) {
    ...
    protected BuiltinFunction clone() {
        return new Bool32x4Constructor(getRealm());
    }

    /**
     * Properties of the SIMD.Bool32x4 Constructor
     */
    public enum Properties {
        ...
        public static final Intrinsics prototype = Intrinsics.SIMD_Bool32x4Prototype;
