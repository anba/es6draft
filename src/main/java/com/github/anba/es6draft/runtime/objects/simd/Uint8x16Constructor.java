 ...
 * <h2>SIMD objects</h2>
 * <ul>
 * <li>The SIMD.Uint8x16 Constructor
 * <li>Properties of the SIMD.Uint8x16 Constructor
 * </ul>
 */
public final class Uint8x16Constructor extends BuiltinConstructor implements Initializable {
    private static final SIMDType SIMD_TYPE = SIMDType.Uint8x16;
    private static final int ELEMENT_SIZE = SIMDType.Uint8x16.getElementSize();
    private static final int VECTOR_LENGTH = SIMDType.Uint8x16.getVectorLength();
    private static final int MIN_VALUE = 0;
    private static final int MAX_VALUE = 0xff;

    public Uint8x16Constructor(Realm realm) {
    ...
    protected BuiltinFunction clone() {
        return new Uint8x16Constructor(getRealm());
    }
    ...
    public enum Properties {
        ...
        public static final Intrinsics prototype = Intrinsics.SIMD_Uint8x16Prototype;
        ...
        public static Object splat(ExecutionContext cx, Object thisValue, Object n) {
            ...
            Arrays.fill(list, n);
            /* step 2 */
            return SIMDCreateInt(cx, SIMD_TYPE, list, AbstractOperations::ToUint8);
        }
        ...
        public static Object add(ExecutionContext cx, Object thisValue, Object a, Object b) {
            ...
            /* steps 2-3 */
            SIMDValue result = SIMDBinaryOpInt(sa, sb, (x, y) -> (x + y) & 0xff);
            /* step 4 */
            return result;
        }
        ...
        public static Object neg(ExecutionContext cx, Object thisValue, Object a) {
            ...
            SIMDValue sa = simdValue(cx, a, SIMD_TYPE);
            /* steps 2-3 */
            SIMDValue result = SIMDUnaryOpInt(sa, x -> (-x) & 0xff);
            /* step 4 */
            return result;
        }
        ...
        public static Object shiftLeftByScalar(ExecutionContext cx, Object thisValue, Object a, Object bits) {
            ...
            /* steps 4-5 */
            SIMDValue result = SIMDScalarOp(sa, (int) scalar, (x, y) -> (x << y) & 0xff);
            /* step 6 */
            return result;
        }
        ...
        public static Object extractLane(ExecutionContext cx, Object thisValue, Object simd, Object lane) {
            ...
            /* step 2 */
            return SIMDExtractLaneInt(sv, SIMDToLane(cx, VECTOR_LENGTH, lane)) & 0xff;
        }
        ...
        public static Object replaceLane(ExecutionContext cx, Object thisValue, Object simd, Object lane,
            ...
            SIMDValue sv = simdValue(cx, simd, SIMD_TYPE);
            /* step 2 */
            return SIMDReplaceLaneInt(cx, sv, lane, value, AbstractOperations::ToUint8);
        }
        ...
        /**
         * SIMD Constructor.from TIMD ( value ), TIMD = Int8x16
         * 
         * @param cx
         *            the execution context
         * @param thisValue
         ...
         * @return the new SIMD value
         */
        @Function(name = "fromInt8x16", arity = 1)
        public static Object fromInt8x16(ExecutionContext cx, Object thisValue, Object value) {
            /* step 1 */
            SIMDValue simd = simdValue(cx, value, SIMDType.Int8x16);
            /* step 2 */
            int[] list = simd.asInt().clone();
            /* step 3 (not applicable for Int8x16) */
