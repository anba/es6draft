 ...
 * <h2>SIMD objects</h2>
 * <ul>
 * <li>Properties of the SIMD.Uint16x8 Prototype Object
 * </ul>
 */
public final class Uint16x8Prototype extends OrdinaryObject implements Initializable {
    ...
    public Uint16x8Prototype(Realm realm) {
        super(realm);
    }
    ...
    /**
     * Properties of the SIMD.Uint16x8 Prototype Object
     */
    public enum Properties {
        ...
        public static final Intrinsics constructor = Intrinsics.SIMD_Uint16x8;
        ...
        public static Object toLocaleString(ExecutionContext cx, Object thisValue, Object locales, Object options) {
            ...
            for (int i = 0; i < VECTOR_LENGTH; ++i) {
                double element = value.asInt()[i] & 0xffff;
                /* steps 5.a-c */
