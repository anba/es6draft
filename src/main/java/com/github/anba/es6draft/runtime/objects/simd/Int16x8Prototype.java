 ...
 * <h2>SIMD objects</h2>
 * <ul>
 * <li>Properties of the SIMD.Int16x8 Prototype Object
 * </ul>
 */
public final class Int16x8Prototype extends OrdinaryObject implements Initializable {
    ...
    public Int16x8Prototype(Realm realm) {
        super(realm);
    }
    ...
    /**
     * Properties of the SIMD.Int16x8 Prototype Object
     */
    public enum Properties {
        ...
        public static final Intrinsics constructor = Intrinsics.SIMD_Int16x8;
        ...
        public static Object toLocaleString(ExecutionContext cx, Object thisValue, Object locales, Object options) {
            ...
            for (int i = 0; i < VECTOR_LENGTH; ++i) {
                double element = (short) value.asInt()[i];
                /* steps 5.a-c */
