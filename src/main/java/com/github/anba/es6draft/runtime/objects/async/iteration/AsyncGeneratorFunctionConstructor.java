...
import static com.github.anba.es6draft.runtime.types.builtins.OrdinaryAsyncGenerator.FunctionAllocate;
...
public final class AsyncGeneratorFunctionConstructor extends BuiltinConstructor implements Initializable {
    ...
    @Override
    public AsyncGeneratorFunctionConstructor clone() {
        return new AsyncGeneratorFunctionConstructor(getRealm());
    }
