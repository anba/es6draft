 ...
 * </ul>
 */
public final class OrdinaryConstructorGenerator extends FunctionObject implements Constructor {
    /**
     ...
     *            the realm object
     */
    protected OrdinaryConstructorGenerator(Realm realm) {
        super(realm);
    }

    @Override
    protected OrdinaryConstructorGenerator allocateNew() {
     ...
     */
    public static OrdinaryConstructorGenerator FunctionAllocate(ExecutionContext cx, ScriptObject functionPrototype,
     ...
     * @return the new generator function object
     */
    public static OrdinaryConstructorGenerator ConstructorGeneratorFunctionCreate(ExecutionContext cx,
