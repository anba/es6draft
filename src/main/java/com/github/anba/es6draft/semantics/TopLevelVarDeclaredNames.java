 ...
 */
class TopLevelVarDeclaredNames extends StaticSemanticsVisitor<List<String>, List<String>> {
    static final NodeVisitor<List<String>, List<String>> INSTANCE = new TopLevelVarDeclaredNames();

    @Override
    public List<String> visit(Statement node, List<String> value) {
        node.accept(VarDeclaredNames.INSTANCE, value);
        return value;
    }

    @Override
    public List<String> visit(FunctionDeclaration node, List<String> value) {
        node.accept(LexicallyDeclaredNames.INSTANCE, value);
        return value;
    }
