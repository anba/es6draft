...
public final class ForInStatement extends IterationStatement implements ForIterationNode {
    ...
    public ForInStatement(long beginPosition, long endPosition, BlockScope scope, EnumSet<Abrupt> abrupt,
            Set<String> labelSet, Node head, Expression expression, Statement statement) {
