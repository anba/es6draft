...
description: |
  Create a Function with the function parameters being an unclosed multi-line comment.
info: >
...
// Check unclosed multi-line comments don't extend into the function body.
Function("/*", "*/) {");
