...
info: Check TypeError is thrown from correct realm with tco-call to proxied revoked proxy from [[Construct]] invocation.
description: >
...
// - Proxy functions don't push a new execution context on the execution context stack.
// - Calling the revoked proxy throws a TypeError from the current realm, that means this realm and not `otherRealm`.
var code = "'use strict'; (function() { var p = Proxy.revocable(function(){}, {}); var f = new Proxy(p.proxy, {}); p.revoke(); return f(); });";
