...
// slice() with different realm constructor (1)
{
  ...
  // array1.constructor is from a different realm, but is not the %Array% intrinsic, slice() creates Array sub-class instances
  assertTrue(Array.isArray(array2));
...
// slice() with different realm constructor (3)
{
  const ForeignArray = new Reflect.Realm().eval("Array");
  const obj1 = {}, obj2 = {};
...
// slice() with different realm constructor (4)
{
  const ForeignArray = new Reflect.Realm().eval("Array");
  const obj1 = {}, obj2 = {};
...
// slice() with proxied constructor and with different realm constructor (1)
{
  const ForeignMyArray = new Reflect.Realm().eval(`
    class MyArray extends Array { }
    MyArray;
...
// slice() with proxied constructor and with different realm constructor (2)
{
  class MyArray extends Array { }
  const ForeignArray = new Reflect.Realm().eval("Array");
  const obj1 = {}, obj2 = {};
...
// slice() with proxied constructor and with different realm constructor (3)
{
  const ForeignArray = new Reflect.Realm().eval("Array");
  const obj1 = {}, obj2 = {};
  let array1 = new Array(obj1, obj2);
...
// slice() with proxied constructor and with different realm constructor (4)
{
  const ForeignArray = new Reflect.Realm().eval("Array");
  const obj1 = {}, obj2 = {};
  let array1 = new ForeignArray(obj1, obj2);
...
// slice() with bound constructor, without @@species
{
  class MyArray extends Array { }
  const obj1 = {}, obj2 = {};
  let array1 = new MyArray(obj1, obj2);
  ...
  // @@species is undefined, slice() creates default Array instances
  assertTrue(Array.isArray(array2));
  assertSame(Array, array2.constructor);
  assertSame(Array.prototype, Object.getPrototypeOf(array2));
  assertSameArray(array1, array2);
...
// slice() with bound constructor, with @@species
{
  class MyArray extends Array { }
  const obj1 = {}, obj2 = {};
  let array1 = new MyArray(obj1, obj2);
  ...
  // Bound function objects do not have a [[Realm]] internal slot, realm retrieved from bound target
  // @@species is not undefined, slice() creates Array sub-class instances
  assertTrue(Array.isArray(array2));
  assertSame(MyArray, array2.constructor);
  assertSame(MyArray.prototype, Object.getPrototypeOf(array2));
  assertSameArray(array1, array2);
...
// slice() with bound constructor and with different realm constructor (1a), without @@species
{
  const ForeignMyArray = new Reflect.Realm().eval(`
    class MyArray extends Array { }
    MyArray;
...
// slice() with bound constructor and with different realm constructor (1b), without @@species
{
  const ForeignMyArray = new Reflect.Realm().eval(`
    class MyArray extends Array { }
    MyArray;
...
// slice() with bound constructor and with different realm constructor (1a), with @@species
{
  const ForeignMyArray = new Reflect.Realm().eval(`
    class MyArray extends Array { }
    MyArray;
...
// slice() with bound constructor and with different realm constructor (1b), with @@species
{
  const ForeignMyArray = new Reflect.Realm().eval(`
    class MyArray extends Array { }
    MyArray;
...
// slice() with bound constructor and with different realm constructor (2a), without @@species
{
  class MyArray extends Array { }
  const ForeignArray = new Reflect.Realm().eval("Array");
  const obj1 = {}, obj2 = {};
...
// slice() with bound constructor and with different realm constructor (2b), without @@species
{
  class MyArray extends Array { }
  const ForeignArray = new Reflect.Realm().eval("Array");
...
// slice() with bound constructor and with different realm constructor (2a), with @@species
{
  class MyArray extends Array { }
  const ForeignArray = new Reflect.Realm().eval("Array");
  const obj1 = {}, obj2 = {};
...
// slice() with bound constructor and with different realm constructor (2b), with @@species
{
  class MyArray extends Array { }
  const ForeignArray = new Reflect.Realm().eval("Array");
  const ForeignFunction = ForeignArray.constructor;
