...

{
  ...
  assertDate(local, utc, TimeZone(-10), {
    String: "Thu Dec 29 2011 00:00:00 GMT-1000 (-10)",
    DateString: "Thu Dec 29 2011",
    TimeString: "00:00:00 GMT-1000 (-10)",
...

{
  ...
  assertDate(local, utc, TimeZone(+14), {
    String: "Sat Dec 31 2011 00:00:00 GMT+1400 (+14)",
...

{
  ...
  assertDate(local, utc, TimeZone(+13), {
    String: "Mon Apr 02 2012 00:00:00 GMT+1300 (+13)",
    DateString: "Mon Apr 02 2012",
    TimeString: "00:00:00 GMT+1300 (+13)",
