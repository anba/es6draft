...
assertSame(void 0, eval(`var c = 0; 0; do if (c) break; else c = 1; while (True());`));
assertSame(void 0, eval(`var c = 0; 0; do if (c++) continue; else c = 1; while (c < 2);`));

// With-Statement
assertSame(void 0, eval(`0; with ({}) ;`));
assertSame(1, eval(`0; with ({}) 1;`));
assertSame(void 0, eval(`0; L: with ({}) break L;`));
assertSame(void 0, eval(`0; L: { 1; with ({}) break L; }`));
assertSame(2, eval(`0; L: { 1; with ({}) { 2; break L; } }`));
...
assertSame(void 0, eval(`K: { 1; L: if (False()) break L; else break K; }`));
