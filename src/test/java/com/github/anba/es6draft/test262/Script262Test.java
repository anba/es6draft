...
/**
 * Local test262 test suite
 */
@RunWith(Parallelized.class)
@UseParametersRunnerFactory(ParameterizedRunnerFactory.class)
@TestConfiguration(name = "script.262", file = "resource:/test-configuration.properties")
public final class Script262Test {
    private static final Configuration configuration = loadConfiguration(Script262Test.class);
    ...
    private boolean isValidTestConfiguration() {
        return test.hasMode(isStrictTest, DefaultMode.Both) && test.hasFeature(includeFeatures, excludeFeatures);
    }
    ...
    public void setUp() throws Throwable {
        ...
        if (!realm.initialize(test, Test262Info::readLocalFile, this::isValidTestConfiguration)) {
            return;
        }
