...
@TestConfiguration(name = "natives.test.default", file = "resource:/test-configuration.properties")
public final class NativesDefaultTest {
    private static final Configuration configuration = loadConfiguration(NativesDefaultTest.class);
    ...
    @ClassRule
    public static TestRealms<TestInfo> realms = new TestRealms<TestInfo>(configuration, RealmData::new) {
        @Override
