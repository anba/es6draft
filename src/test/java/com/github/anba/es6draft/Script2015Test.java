...
@TestConfiguration(name = "script.2015", file = "resource:/test-configuration.properties")
public final class Script2015Test {
    private static final Configuration configuration = loadConfiguration(Script2015Test.class);
